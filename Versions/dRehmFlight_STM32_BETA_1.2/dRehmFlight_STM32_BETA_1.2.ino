...
//Setup gyro and accel full scale value selection and scale factor
  ...
  #define GYRO_FS_SEL_250    MPU6000_GYRO_FS_250
  #define GYRO_FS_SEL_500    MPU6000_GYRO_FS_500
  #define GYRO_FS_SEL_1000   MPU6000_GYRO_FS_1000
  #define GYRO_FS_SEL_2000   MPU6000_GYRO_FS_2000
  #define ACCEL_FS_SEL_2     MPU6000_ACCEL_FS_2
  #define ACCEL_FS_SEL_4     MPU6000_ACCEL_FS_4
  #define ACCEL_FS_SEL_8     MPU6000_ACCEL_FS_8
  #define ACCEL_FS_SEL_16    MPU6000_ACCEL_FS_16
...
Servo servo1;  //create servo object to control a servo or ESC with PWM
Servo servo2;
Servo servo3;
Servo servo4;
Servo servo5;
...
#else
  #error Bad MPU definition, select either MPU6050 or MPU9250... 
#endif
...
void IMUinit() {
   ...
   */
    ...
    // set slaveSelect pin output high (set BSRR bit) first avoids transient low
